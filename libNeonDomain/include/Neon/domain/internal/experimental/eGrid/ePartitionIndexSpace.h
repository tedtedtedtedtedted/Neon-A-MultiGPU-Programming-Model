...
class ePartitionIndexSpace
{
   public:
    ePartitionIndexSpace() = default;
    virtual ~ePartitionIndexSpace() = default;
   ...
   private:
    NEON_CUDA_HOST_DEVICE inline auto setCell(Cell&                          cell,
...
#include "Neon/domain/internal/eGrid/ePartitionIndexSpace_imp.h"