...
template <typename T, int C>
ePartition<T, C>::ePartition(Neon::DataView  dataView,
                             T*              mem,
                             int             cardinality,
...
template <typename T, int C>
NEON_CUDA_HOST_DEVICE inline auto ePartition<T, C>::mapToGlobal(const Cell& cell) const -> Neon::index_3d
{
...
template <typename T, int C>
inline NEON_CUDA_HOST_DEVICE auto ePartition<T, C>::cardinality() const -> int
{
    return mCardinality;
}

template <typename T, int C>
inline NEON_CUDA_HOST_DEVICE auto ePartition<T, C>::operator()(const bCell& cell,
                                                               int          card) -> T&
{
...
template <typename T, int C>
inline NEON_CUDA_HOST_DEVICE auto ePartition<T, C>::pitch(const Cell& cell, int card) const -> uint32_t
{
...
template <typename T, int C>
NEON_CUDA_HOST_DEVICE inline auto ePartition<T, C>::setNghCell(const Cell&     cell,
...
template <typename T, int C>
NEON_CUDA_HOST_DEVICE inline auto ePartition<T, C>::nghVal(const Cell& eId,
                                                           uint8_t     nghID,
                                                           int         card,
...
template <typename T, int C>
NEON_CUDA_HOST_DEVICE inline auto ePartition<T, C>::nghVal(const Cell&     cell,
...
template <typename T, int C>
inline NEON_CUDA_HOST_DEVICE auto ePartition<T, C>::shmemPitch(
    Cell      cell,
...
template <typename T, int C>
NEON_CUDA_HOST_DEVICE inline auto ePartition<T, C>::loadInSharedMemory(
...
template <typename T, int C>
NEON_CUDA_HOST_DEVICE inline auto ePartition<T, C>::loadInSharedMemoryAsync(
    [[maybe_unused]] const Cell&                cell,
    [[maybe_unused]] const nghIdx_t::Integer    stencilRadius,
    [[maybe_unused]] Neon::sys::ShmemAllocator& shmemAlloc) const -> void
{
